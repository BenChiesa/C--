/*
Given an array positive numbers, find the maximum sum of a subsequence such that
no two numbers in the sequence are adjacent in the array.
...
int maxSum(vector<int>& nums) {
    ...
    int inclusive = nums[0], exclusive = 0;
